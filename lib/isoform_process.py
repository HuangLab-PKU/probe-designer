...
from lib.search_binding import plp_search, seq_minus
...
def plp_isoform(transcripts_raw, genome, plp_kwargs):
    bds_len = plp_kwargs.get('BDS_len')
    tlr_len = plp_kwargs.get('junction_tolerence')
    ...
    # print('2')
    # print(transcripts[-1][f'exon_splices_{2}'])
    # print(exon_splice_counts[2])
    # print('3')
    # print(transcripts[-1][f'exon_splices_{3}'])
    # print(exon_splice_counts[3])

    # summary of all the transcripts
    for transcript in transcripts:
        for num in range(2, splice_def_needed+1):
            # print(num) 
            # print({exon_splice: exon_splice_counts[num][exon_splice] for exon_splice in transcript[f'exon_splices_{num}']})
            ...
            # transcript[f'exon_splices_{num}'] = 1
    # print(transcript[f'exon_splices_{num}'])
    # print(transcript[f'exon_splices_{num}'])
    # print(transcript['exon_splices_3'][(142892457, 142892477), (142892477, 142892480), (142892480, 142892509)])
